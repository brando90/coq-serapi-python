...
let ser_wit_rewstrategy =
  ...
  Ser_genarg.{
    ...
    glb_ser = Ser_rewrite.sexp_of_strategy_ast Ser_genintern.sexp_of_glob_constr_and_expr Ser_tacexpr.sexp_of_raw_red_expr;
    ...
    glb_des = Ser_rewrite.strategy_ast_of_sexp Ser_genintern.glob_constr_and_expr_of_sexp Ser_tacexpr.raw_red_expr_of_sexp;
